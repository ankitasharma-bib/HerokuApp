...
<html lang="en">
  <head>
	...
	<meta name="salesforce-expid" content="<?php echo getenv('EXP_ID');?>">
	...
	<meta http-equiv="Content-Security-Policy" content="default-src 'self' https://learning-spdev-developer-edition.ap18.force.com https://fonts.googleapis.com https://fonts.gstatic.com">
